  ...
  return (
    <main className="min-h-screen px-6 py-20 sm:py-28 max-w-3xl mx-auto text-zinc-100 font-sans">      
      <section className="text-center sm:text-left space-y-6">
        ...
        <p className="text-lg text-zinc-300 leading-relaxed">
          Todo el contenido de este proyecto es y seguirá siendo completamente gratuito. Si te sirvió o te resultó útil, podés apoyarlo con una donación en cafecito App en <a href="https://cafecito.app/onthecode" target="_blank" rel="noopener noreferrer" className="text-blue-400 underline">este enlace</a> ❤️ ¡Gracias!
        </p>
